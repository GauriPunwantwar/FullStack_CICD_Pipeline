...
<a href={`${API_BASE}/health`} target="_blank" rel="noreferrer" style={{ marginLeft:
12 }}>Health</a>
<a href={`${API_BASE}/metrics`} target="_blank" rel="noreferrer" style={{ marginLeft:
12 }}>Metrics</a>
<a href={`${API_BASE}/docs`} target="_blank" rel="noreferrer" style={{ marginLeft: 12
}}>Docs</a>
</div>
